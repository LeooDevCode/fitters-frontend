          ...
          >
            ...
            <div className="field">
              ...
              <input
                ...
                placeholder="Ej: después del cardio"
              />
            </div>
    ...
    <div className="rutina-card-actions">
      ...
      >
        {rutinaAbierta === rutina.id ? '−' : '+'}
                  ...
                  <div
                    className="rutina-card-expand"
                    hidden={rutinaAbierta !== rutina.id}
                  >
                            ...
                            <>
                              ...
                              <div className="edit-campo">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setEditRepeticiones(e.target.value)
                                  }
                                />
                              </div>
                    ...
                    <form
                      ...
                      onSubmit={(e) =>
                        handleAgregarEjercicio(e, rutina.id)
                      }
                    >
